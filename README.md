...
- free utility for acquisition;
- fast one-time services for immediate cash flow;
- recurring subscriptions for MRR;
- higher-ticket B2B products for larger transactions.

Stripe is the primary checkout rail. USDC on Base can be offered as a secondary payment option where appropriate.

## Principles

No fabricated testimonials, fake sales, spam, copied proprietary products or paid advertising without authorization. Revenue is counted only when a real payment is confirmed.
